...
# Mirrors EntityUpdate in Homebox 0.26.1:
# https://github.com/sysadminsmedia/homebox/blob/v0.26.1/backend/internal/data/repo/repo_entities.go
# Two of its fields are deliberately absent: ``id`` (the handler takes it from
# the URL) and ``entityTypeId`` (written only when sent, so leaving it out
